...
public class trabalhoAv1 {
    ...
    class Hotel {
        ...
        public void cadastrarReserva(String nomeHospede, String dataCheckIn, String dataCheckOut, int numeroQuartosReservados, String tipoQuartoReservado) {
            ...
            if (quartosDisponiveis >= numeroQuartosReservados) {
                for (int i = 0; i < numeroQuartosReservados; i++) {
                    for (Quarto quarto : quartos) {
                        if (quarto.isDisponivel() && quarto.getTipo().equals(tipoQuartoReservado)) {
                            quarto.reservar();
                            break;
                ...
                System.out.println("Não há quartos suficientes disponíveis do tipo " + tipoQuartoReservado + ".");
            }
        }
        ...
        public void checkOut(String nomeHospede) {
            for (Reserva reserva : reservas) {
                if (reserva.getNomeHospede().equals(nomeHospede)) {
                    for (Quarto quarto : quartos) {
                        if (!quarto.isDisponivel() && quarto.getTipo().equals(reserva.getTipoQuartoReservado())) {
                            quarto.liberar();
        ...
        public void relatorioHistoricoReservas() {
            ...
            for (Reserva reserva : reservas) {
                System.out.println("Hóspede: " + reserva.getNomeHospede() + ", Data Check-in: " + reserva.getDataCheckIn() + ", Data Check-out: " + reserva.getDataCheckOut() + ", Quartos Reservados: " + reserva.getNumeroQuartosReservados() + ", Tipo de Quarto: " + reserva.getTipoQuartoReservado());
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        trabalhoAv1 trabalho = new trabalhoAv1();
        Hotel hotel = trabalho.new Hotel();
        int opcao;
